...
namespace MurdoxV2.Data.Migrations
{
    ...
    [Migration("20260607092150_UpdateModel_ScamImageRecord")]
    partial class UpdateModel_ScamImageRecord
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MurdoxV2.Features.ScamDetection.ScamImageRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<long>("AHash")
            ...
            modelBuilder.Entity("MurdoxV2.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.PrimitiveCollection<List<string>>("TagLinks")
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("MurdoxV2.Models.Ticket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.PrimitiveCollection<List<string>>("ChatLog")
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("MurdoxV2.Models.Ticket", b =>
                {
                    b.HasOne("MurdoxV2.Models.ServerMember", null)
                        .WithMany("Tickets")
                        .HasForeignKey("ServerMemberId");
                });
